            ...
            <div className="p-4 max-w-xl mx-auto text-xl rounded-xl text-purple-900 bg-white ring-1 ring-black/5 shadow-2xl divide-y divide-purple-300">
                <form class="w-full max-w-xl">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="peanut butter is too sticky for little cat mouths" />
