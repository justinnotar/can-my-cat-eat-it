                ...
                <form class="w-full max-w-xl">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <div class="relative">
                                <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-800 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-400" id="grid-state">
                                <option>yes</option>
                                <option>no</option>
                                <option>maybe</option>
                                </select>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-800 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-400" id="grid-password" type="text" placeholder="peanut butter is too sticky for little cat mouths" />
