...
export default function Home() {
  return (
    <div className="isolate bg-purple-100 overflow-y-hidden min-h-screen">
      ...
      <NavBar />
      <main>
        <div className="relative mx-auto max-w-3xl h-screen">
            ...
            the information provided by can my cat eat xyz? ("we", "us", or "our") on canmycateat.xyz (the "Site") is for general informational purposes only. All information on the Site is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the Site.
